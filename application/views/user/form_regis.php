			...
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-lg-8  col-md-12">
						...
						<input type="text" class="form-control <?php echo form_error('username') ? 'is-invalid' : '' ?>" name="username" placeholder="Username" value="<?php echo set_value('username'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-lg-8  col-md-12">
						...
						<input type="text" class="form-control <?php echo form_error('email') ? 'is-invalid' : '' ?>" name="email" placeholder="user@example.com" value="<?php echo set_value('email'); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-lg-8  col-md-12">
						...
						<input type="password" class="form-control <?php echo form_error('confpassword') ? 'is-invalid' : '' ?>" name="confpassword" placeholder="Masukkan ulang password">
